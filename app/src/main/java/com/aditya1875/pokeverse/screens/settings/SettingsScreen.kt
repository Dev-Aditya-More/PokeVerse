        ...
        Box(
            ...
            Column(
                ...
                SettingsCard(
                    ...
                    Text("Crafted with ❤️ using Jetpack Compose", color = MaterialTheme.colorScheme.onSurface)
                    Text("Version ${BuildConfig.VERSION_NAME}", color = MaterialTheme.colorScheme.onSurface)
                }
